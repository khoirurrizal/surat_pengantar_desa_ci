                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="<?php echo base_url('auth') ?>">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user"id="nama_pengguna" name="nama_pengguna" placeholder="Masukan User Id..."  value="<?php echo set_value('nama_pengguna') ?>" >
                    ...
                    <!-- <div class="text-center">
                      <a href="<?php echo base_url('auth/lupapassword') ?>" class="small">Lupa Password ?</a>
                    </div> -->
